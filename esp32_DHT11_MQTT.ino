/**********
  ...
  Objetivo: Estabelece um WebServer com o ESP32 para o sensor DHT11.
            Estabelece comunicação com o Node-Red via MQTT Broker
  Origem:   https://randomnerdtutorials.com/esp32-mqtt-publish-dht11-dht22-arduino/
  Node-Red Gauge:   https://flows.nodered.org/node/node-red-contrib-ui-artless-gauge
  Dashboard Install:  https://flows.nodered.org/node/node-red-dashboard 
  Problema DashBoard: https://groups.google.com/forum/#!topic/node-red/j015cz2jtNU         
*********/
